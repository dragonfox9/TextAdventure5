...
class Rooms {
    ...
    public static void build(Room[][] room, final int WIDTH, final int HEIGHT) {
        ...
        room[1][2].setNumber(5);
        room[1][2].setName("Test");
        room[1][2].setDescription("Test podpisu");
        room[1][2].setItems("Dupa");
        
        room[2][0].setNumber(6);
        room[2][0].setName("Test2");
        room[2][0].setDescription("Test podpisu2");
        room[2][0].setItems("Dupa");
